 ...
 * @version 02-06-2017
 */
public class DFMCommandManager extends AbstractManager
{    
    ...
    public DFMCommandManager(InetAddress inetaddr, IExceptionListener excListener) {
        super(inetaddr);
        this.q = new CommandQueue(100);
        this.timer = new Timer("YADrone DFMCommandManager Timer");
     ...
     * @return 
     */
    public DFMCommandManager doFor(long millis)
    {
     ...
     * @return 
     */
    public DFMCommandManager after(long millis)
    {
        return waitFor(millis);
    }
     ...
     * @return 
     */
    public DFMCommandManager waitFor(long millis)
    {
        try
        {
            Thread.sleep(millis);
    ...
    public DFMCommandManager landing() {
        q.add(new LandCommand());
        return this;
    }
    
    public DFMCommandManager flatTrim() {
        q.add(new FlatTrimCommand());
        return this;
    }
    
    public DFMCommandManager manualTrim(float pitch, float roll, float yaw) {
        q.add(new ManualTrimCommand(pitch, roll, yaw));
        return this;
    }
    
    public DFMCommandManager takeOff() {
        flatTrim();
     ...
     * @return 
     */
    public DFMCommandManager emergency() {
        q.add(new EmergencyCommand());
        return this;
    }
    
    public DFMCommandManager forward(int speed) {
        return move(0f, -perc2float(speed), 0f, 0f);
    }
    
    public DFMCommandManager backward(int speed) {
        return move(0f, perc2float(speed), 0f, 0f);
    }
    
    public DFMCommandManager spinRight(int speed) {
        return move(0f, 0f, 0f, perc2float(speed));
    }
    
    public DFMCommandManager spinLeft(int speed) {
        return move(0f, 0f, 0f, -perc2float(speed));
    }
    
    public DFMCommandManager up(int speed) {
        return move(0f, 0f, perc2float(speed), 0f);
    }
    
    public DFMCommandManager down(int speed) {
        return move(0f, 0f, -perc2float(speed), 0f);
    }
    
    public DFMCommandManager goRight(int speed) {
        return move(perc2float(speed), 0f, 0f, 0f);
    }
    
    public DFMCommandManager goLeft(int speed) {
        return move(-perc2float(speed), 0f, 0f, 0f);
    }
    
    public DFMCommandManager move(float lrtilt, float fbtilt, float vspeed, float aspeed, float magneto_psi,
    ...
    public DFMCommandManager move(float lrtilt, float fbtilt, float vspeed, float aspeed) {
        lrtilt = limit(lrtilt, -1f, 1f);
        fbtilt = limit(fbtilt, -1f, 1f);
        vspeed = limit(vspeed, -1f, 1f);
        aspeed = limit(aspeed, -1f, 1f);
//		System.out.println("DFMCommandManager: Move lrTilt=" + lrtilt + " fbtilt=" + fbtilt + " vspeed=" + vspeed + " aspeed=" + aspeed);
q.add(new MoveCommand(false, lrtilt, fbtilt, vspeed, aspeed));
return this;
    }
    
    public DFMCommandManager move(int speedX, int speedY, int speedZ, int speedSpin) {
        return move(-perc2float(speedY), -perc2float(speedX), -perc2float(speedZ), -perc2float(speedSpin));
    }
    
    public DFMCommandManager freeze() {
        q.add(new FreezeCommand());
        return this;
    }
    
    public DFMCommandManager hover() {
    ...
    private DFMCommandManager setMulticonfiguration()
    {
    ...
    public DFMCommandManager setConfigurationIds() {
     ...
     * @return 
     */
    public DFMCommandManager setVideoCodecFps(int fps) {
     ...
     * @return 
     */
    public DFMCommandManager setVideoBitrateControl(VideoBitRateMode mode) {
     ...
     * @return 
     */
    public DFMCommandManager setVideoBitrate(int rate) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxVideoBitrate(int rate) {
        rate = limit(rate, H264.MIN_BITRATE, H264.MAX_BITRATE);
     ...
     * @return 
     */
    public DFMCommandManager setVideoCodec(VideoCodec c) {
     ...
     * @return 
     */
    public DFMCommandManager setVideoOnUsb(boolean b) {
...
//	}
     ...
     * @return 
     */
    public DFMCommandManager setNavDataDemo(boolean b) {
     ...
     * @return 
     */
    public DFMCommandManager setNavDataOptions(int mask) {
     ...
     * @return 
     */
    public DFMCommandManager setLedsAnimation(LEDAnimation anim, float freq, int duration) {
     ...
     * @return 
     */
    public DFMCommandManager setDetectEnemyWithoutShell(boolean b) {
...
//	}
     ...
     * @return 
     */
    public DFMCommandManager setEnemyColors(EnemyColor c) {
     ...
     * @return 
     */
    public DFMCommandManager setDetectionType(CadType type) {
     ...
     * @return 
     */
    public DFMCommandManager setDetectionType(DetectionType dt, VisionTagType[] tagtypes) {
        int mask = VisionTagType.getMask(tagtypes);
        q.add(new ConfigureCommand("detect:" + dt.getCmdSuffix(), mask));
        return this;
    }
    
    public DFMCommandManager setVisionParameters(int coarse_scale, int nb_pair, int loss_per, int nb_tracker_width,
    ...
    public DFMCommandManager setVisionOption(int option) {
        q.add(new VisionOptionCommand(option));
        return this;
    }
    
    // TODO find out if still supported in Drone 2.0
    public DFMCommandManager setGains(int pq_kp, int r_kp, int r_ki, int ea_kp, int ea_ki, int alt_kp, int alt_ki, int vz_kp,
    ...
    // TODO find out if still supported in Drone 2.0
    public DFMCommandManager setRawCapture(boolean picture, boolean video) {
     ...
     * @return 
     */
    public DFMCommandManager setEnableCombinedYaw(boolean b) {
        int level = 1;
        if (b) {
            level |= (1 << 2);
        }
     ...
     * @return 
     */
    public DFMCommandManager setFlyingMode(FlyingMode mode) {
     ...
     * @return 
     */
    public DFMCommandManager setHoveringRange(int range) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxEulerAngle(float angle) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxEulerAngle(Location l, float angle) {
        angle = limit(angle, 0f, 0.52f);
        System.out.println("DFMCommandManager: setMaxEulerAngle (bendingAngle): " + angle + " rad");
     ...
     * @return 
     */
    public DFMCommandManager setMaxAltitude(int altitude) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxAltitude(Location l, int altitude) {
        altitude = limit(altitude, 0, 100000);
        System.out.println("DFMCommandManager: setMaxAltitude: " + altitude + " mm");
     ...
     * @return 
     */
    public DFMCommandManager setMinAltitude(int altitude) {
     ...
     * @return 
     */
    public DFMCommandManager setMinAltitude(Location l, int altitude) {
        altitude = limit(altitude, 0, 100000);
     ...
     * @return 
     */
    public DFMCommandManager setMaxVz(int speed) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxVz(Location l, int speed) {
        speed = limit(speed, 0, 2000);
        System.out.println("DFMCommandManager: setMaxVz (verticalSpeed): " + speed + " mm");
     ...
     * @return 
     */
    public DFMCommandManager setMaxYaw(float speed) {
     ...
     * @return 
     */
    public DFMCommandManager setMaxYaw(Location l, float speed) {
    ...
    public DFMCommandManager setCommand(ATCommand command) {
        q.add(command);
        return this;
    }
     ...
     * @return 
     */
    public DFMCommandManager setOutdoor(boolean flying_outdoor, boolean outdoor_hull) {
        System.out.println("DFMCommandManager: setOutdoor(flyingOutdoor,usingOutdoorHull) = " + flying_outdoor + "," + outdoor_hull);
...
//	}
    ...
    public DFMCommandManager animate(FlightAnimation a) {
        q.add(new FlightAnimationCommand(a));
        return this;
    }
    
    public DFMCommandManager setPosition(double latitude, double longitude, double altitude) {
     ...
     * @return 
     */
    public DFMCommandManager setUltrasoundFrequency(UltrasoundFrequency f) {
     ...
     * @return 
     */
    public DFMCommandManager setSSIDSinglePlayer(String ssid) {
     ...
     * @return 
     */
    public DFMCommandManager setSSIDMultiPlayer(String ssid) {
     ...
     * @return 
     */
    public DFMCommandManager setWifiMode(WifiMode mode) {
    ...
    public DFMCommandManager startRecordingPictures(int delay, int nshots) {
        Date d = new Date();
...
//	}
    ...
    private DFMCommandManager initARDrone()
    {
        new Thread(this::setMulticonfiguration).start();;
    ...
    private synchronized void sendCommand(ATCommand c) throws InterruptedException, IOException {
        if (!(c instanceof KeepAliveCommand)) {
            System.out.println("DFMCommandManager: send " + c.getCommandString(seq));
        }
        
        String config = "AT*CONFIG_IDS=" + (seq++) + ",\"" + DFMCommandManager.SESSION_ID + "\",\"" + DFMCommandManager.PROFILE_ID +"\",\"" + DFMCommandManager.APPLICATION_ID + "\"" + "\r"; // AT*CONFIG_IDS=5,"aabbccdd","bbccddee","ccddeeff"
    ...
    /*
    * TODO consider to refactor controlAck handling into a separate class shared by NavDataManager and DFMCommandManager
    */
    private final Object controlAckLock = new Object();
    private boolean controlAck = false;
    
    public DFMCommandManager setControlAck(boolean b) {
